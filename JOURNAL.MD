...
This allows us to establish a serial connection to the ESP32 over USB instead of directly connecting to the RX0 and TX0 pins on the ESP32. This should make flashing firmware and debugging much easier.  
